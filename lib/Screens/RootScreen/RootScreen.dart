...
import '../../Repos/BackgroundFetch.dart';
...
class _RootScreenState extends State<RootScreen> with WidgetsBindingObserver {
  ...
  void checkPermission() async {
    if (await Permission.locationAlways.status.isGranted == false) {
  ...
  void initState() {
    super.initState();
    BackgroundFETCH().initPlatformState();
    BackgroundFETCH().initSmth();
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () async {
                            BackgroundFETCH().onClickEnable(true);
                            BackgroundFETCH().onClickStatus();
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            BackgroundFETCH().onClickEnable(false);
                            BackgroundFETCH().onClickStatus();
                            if (Platform.isAndroid) {
